...
import { generateDistanceOverlays } from '../../lib/overlays';

export default function DistanceOverlays() {
    const trips = useTripStore((state) => state.trips);
    const overlays = generateDistanceOverlays(trips);
    ...
    if (overlays.length === 0) {
        return <p>No distances to overlay.</p>;
    }
